"""`okapipy fetch-language` command implementation.

Registered on the root `app` in `cli/__init__.py`; this module just
defines the function with a Typer-friendly signature.
"""
